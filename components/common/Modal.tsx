...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, children, title }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-[var(--bg-secondary)] rounded-lg shadow-2xl p-6 w-full max-w-lg m-4 border border-[var(--border-primary)] transform transition-all duration-300 scale-95 animate-fade-in"
